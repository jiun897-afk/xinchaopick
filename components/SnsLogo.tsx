    ...
    case "틱톡":
      return (
        <svg width={s} height={s} viewBox="0 0 24 24">
          ...
          <path d="M13.8 5h2.1c.2 1.6 1.3 2.9 3.1 3.1v2.2c-1.2 0-2.3-.4-3.2-1v4.9c0 2.7-1.9 4.8-4.6 4.8-2.6 0-4.6-2-4.6-4.5 0-2.6 2.2-4.7 5-4.5v2.3c-1.5-.3-2.8.7-2.8 2.1 0 1.3 1 2.3 2.3 2.3 1.4 0 2.5-1.1 2.5-2.6V5z" fill="#25F4EE" transform="translate(-.5 -.3)" />
          <path d="M13.8 5h2.1c.2 1.6 1.3 2.9 3.1 3.1v2.2c-1.2 0-2.3-.4-3.2-1v4.9c0 2.7-1.9 4.8-4.6 4.8-2.6 0-4.6-2-4.6-4.5 0-2.6 2.2-4.7 5-4.5v2.3c-1.5-.3-2.8.7-2.8 2.1 0 1.3 1 2.3 2.3 2.3 1.4 0 2.5-1.1 2.5-2.6V5z" fill="#FE2C55" transform="translate(.5 .3)" />
          <path d="M13.8 5h2.1c.2 1.6 1.3 2.9 3.1 3.1v2.2c-1.2 0-2.3-.4-3.2-1v4.9c0 2.7-1.9 4.8-4.6 4.8-2.6 0-4.6-2-4.6-4.5 0-2.6 2.2-4.7 5-4.5v2.3c-1.5-.3-2.8.7-2.8 2.1 0 1.3 1 2.3 2.3 2.3 1.4 0 2.5-1.1 2.5-2.6V5z" fill="#fff" />
        </svg>
      );
    case "X":
      return (
